...
下面是Marshal对[12.3节](12.3.%20Display，一个递归的值打印器)的strangelove变量编码后的结果：
...
在[12.6节](12.6.%20示例：解码S表达式)中，我们将给出S表达式解码器的实现步骤，但是在那之前，我们还需要先了解如何通过反射技术来更新程序的变量。
...
**练习 12.7：** 创建一个基于流式的API，用于S表达式的解码，和json.Decoder([§4.5](4.5.%20JSON))函数功能类似。
