...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/copyto.svg" alt="复制数据以在同一设备上执行操作" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 5.6.1 复制数据以在同一设备上执行操作</p>
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1843)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1841)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1842)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11782)。
