...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/capacity-vs-error.svg" alt="模型复杂度对欠拟合和过拟合的影响" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 4.4.1 模型复杂度对欠拟合和过拟合的影响</p>
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1807)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1806)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1805)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11771)。
