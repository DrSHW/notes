...
回想一下，在多项式回归的例子（ *小节《4.4 模型选择、欠拟合和过拟合.md》中*）中，
...
这正是我们想要的。
让我们回顾一下 *小节《3.1 线性回归.md》中*中的线性回归例子。
我们的损失由下式给出：
...
从 *章节《03 线性神经网络》中*以来，线性网络和平方损失没有变化，
...
1. 我们知道$\|\mathbf{w}\|^2 = \mathbf{w}^\top \mathbf{w}$。能找到类似的矩阵方程吗（见 *小节《2.3 线性代数》中范数部分* 中的Frobenius范数）？
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1810)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1808)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1809)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11773)。
