...
曾经sigmoid函数$1/(1 + \exp(-x))$（ *小节《4.1 多层感知机.md》中*提到过）很流行，
因为它类似于阈值函数。
...
在前面的部分中，例如在 *小节《3.3 线性回归的简洁实现.md》中*中，
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1819)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1818)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1817)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11776)。
