...
如果我们想参加Kaggle比赛，首先需要注册一个账户（见 图 4.10.1 ）。

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/kaggle.png" alt="Kaggle网站" style="width:`400px`
;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 4.10.1 Kaggle网站</p>
在房价预测比赛页面（如 图 4.10.2  所示）的"Data"选项卡下可以找到数据集。我们可以通过下面的网址提交预测，并查看排名：

>https://www.kaggle.com/c/house-prices-advanced-regression-techniques

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/house-pricing.png" alt="房价预测比赛页面" style="width:`400px`
;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 4.10.2 房价预测比赛页面</p>
## 访问和读取数据集
...
我们只能在官方测试集中评估我们的模型。
在 图 4.10.2  中，"Data"选项卡有下载数据的链接。

开始之前，我们将[**使用`pandas`读入并处理数据**]，
这是我们在 *小节《2.2 数据预处理.md》中*中引入的。
...
$$
\sqrt{\frac{1}{n}\sum_{i=1}^n\left(\log y_i -\log \hat{y}_i\right)^2}.\tag{4.10.2}
$$
...
本书在讨论模型选择的部分（ *小节《4.4 模型选择、欠拟合和过拟合.md》中*）
中介绍了[**K折交叉验证**]，
它有助于模型选择和超参数调整。
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/kaggle-submit2.png" alt="向Kaggle提交数据" style="width:`400px`
;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 4.10.3 向Kaggle提交数据</p>
## 小结
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1823)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1824)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1825)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11775)。
