...
$$
 \exp\left(\min\left(0, 1 - \frac{len_{\text{label}}}{len_{\text{pred}}}\right)\right) \prod_{n=1}^k p_n^{1/2^n},\tag{14.1.1}
$$
...
![](C:/Users/17100/Desktop/知识库/深度学习方法/img/qr_machine-translation.svg)
