...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/conv1d.svg" alt="一维互相关运算" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 15.3.1 一维互相关运算</p>
```python
def corr1d(X, K):
    w = K.shape[0]
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/conv1d-channel.svg" alt="含3个输入通道的一维互相关运算" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 15.3.2 含3个输入通道的一维互相关运算</p>
```python
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/conv1d-2d.svg" alt="单输入通道的二维互相关运算" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 15.3.3 单输入通道的二维互相关运算</p>
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/textcnn.svg" alt="textCNN的设计" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 15.3.4 textCNN的设计</p>
```python
...
![](C:/Users/17100/Desktop/知识库/深度学习方法/img/qr_sentiment-analysis-cnn.svg)
