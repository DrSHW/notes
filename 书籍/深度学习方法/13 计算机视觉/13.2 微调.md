...
本节将介绍迁移学习中的常见技巧:*微调*（fine-tuning）。如 图 13.2.1 所示，微调包括以下四个步骤。
...
<p style="text-align:center">图 13.2.1 微调。</p>
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2893)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2894)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11802)。
