...
前面的章节（例如 *小节《7.1 深度卷积神经网络（AlexNet）.md》中*— *小节《7.4 含并行连结的网络（GoogLeNet）.md》中*）介绍了各种图像分类模型。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2943)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2944)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11803)。
