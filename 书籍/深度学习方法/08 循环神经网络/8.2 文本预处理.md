...
对于序列数据处理问题，我们在 *小节《8.1 序列模型.md》中*中
评估了所需的统计工具和预测时面临的挑战。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2093)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2094)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2095)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11796)。
