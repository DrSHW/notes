...
正如我们所料，评论的长度各不相同。为了每次处理一小批量这样的评论，我们通过截断和填充将每个评论的长度设置为500。这类似于 *小节《9.5 机器翻译与数据集.md》中*中对机器翻译数据集的预处理步骤。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5725)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5726)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11825)。
