...
本节我们将使用刚刚在 *小节《3.5 图像分类数据集.md》中*中引入的Fashion-MNIST数据集，
并设置数据迭代器的批量大小为256。
...
如 *小节《2.3 线性代数》中降维部分*和
 *小节《2.3 线性代数》中非降维求和部分*所述，
...
接下来，我们实现 *小节《3.4 softmax回归.md》中*中引入的交叉熵损失函数。
...
在我们看过 *小节《3.2 线性回归的从零开始实现.md》中*中的线性回归实现，
...
作为一个从零开始的实现，我们使用 *小节《3.2 线性回归的从零开始实现.md》中*中定义的
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1791)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1789)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1790)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11760)。
