...
$$
 公式 3.1.1 中的$w_{\mathrm{area}}$和$w_{\mathrm{age}}$
...
$$
（广播机制在 *小节《2.1 数据操作》中广播机制部分*中有详细介绍）。
...
为了进一步说明，来看下面的例子。
我们为一维情况下的回归问题绘制图像，如 图 3.1.1 所示。

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/fit-linreg.svg" alt="用线性模型拟合数据。" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 3.1.1 用线性模型拟合数据。</p>
...
$$
公式 公式 3.1.10 中的$\mathbf{w}$和$\mathbf{x}$都是向量。
...
在 图 3.1.2 中，我们将线性回归模型描述为一个神经网络。
需要注意的是，该图只显示连接模式，即只显示每个输入如何连接到输出，隐去了权重和偏置的值。

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/singleneuron.svg" alt="线性回归是一个单层神经网络。" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 3.1.2 线性回归是一个单层神经网络。</p>
...
也就是说， 图 3.1.2 中神经网络的*层数*为1。
我们可以将线性回归模型视为仅由单个人工神经元组成的神经网络，或称为单层神经网络。

对于线性回归，每个输入都与每个输出（在本例中只有一个输出）相连，
我们将这种变换（ 图 3.1.2 中的输出层）
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/neuron.svg" alt="真实的神经元。" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 3.1.3 真实的神经元。</p>
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1774)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1775)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/1776)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11688)。
