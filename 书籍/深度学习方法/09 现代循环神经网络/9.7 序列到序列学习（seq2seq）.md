...
正如我们在 *小节《9.5 机器翻译与数据集.md》中*中看到的，
机器翻译中的输入序列和输出序列都是长度可变的。
为了解决这类问题，我们在 *小节《9.6 编码器-解码器架构.md》中*中
设计了一个通用的”编码器－解码器“架构。
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/seq2seq.svg" alt="使用循环神经网络编码器和循环神经网络解码器的序列到序列学习" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.7.1 使用循环神经网络编码器和循环神经网络解码器的序列到序列学习</p>
特定的“&lt;eos&gt;”表示序列结束词元。
...
类似于 *小节《8.3 语言模型和数据集.md》中*中语言模型的训练，
可以允许标签成为原始的输出序列，
从源序列词元“&lt;bos&gt;”“Ils”“regardent”“.”
到新序列词元
“Ils”“regardent”“.”“&lt;eos&gt;”来移动预测的位置。

下面，我们动手构建 图 9.7.1 的设计，
并将基于 *小节《9.5 机器翻译与数据集.md》中*中
...
循环层返回变量的说明可以参考 *小节《8.6 循环神经网络的简洁实现.md》中*。
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/seq2seq-details.svg" alt="循环神经网络编码器-解码器模型中的层" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.7.2 循环神经网络编码器-解码器模型中的层</p>

在每个时间步，解码器预测了输出词元的概率分布。
类似于语言模型，可以使用softmax来获得分布，
并通过计算交叉熵损失函数来进行优化。
回想一下 *小节《9.5 机器翻译与数据集.md》中*中，
特定的填充词元被添加到序列的末尾，
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/seq2seq-predict.svg" alt="使用循环神经网络编码器-解码器逐词元地预测输出序列。" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.7.3 使用循环神经网络编码器-解码器逐词元地预测输出序列。</p>
...
所以 公式 9.7.4 中乘法项之前的系数用于惩罚较短的预测序列。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2783)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2782)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11838)。