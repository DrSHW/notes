...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/hmm.svg" alt="隐马尔可夫模型" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.4.1 隐马尔可夫模型</p>
...
添加了反向传递信息的隐藏层，以便更灵活地处理此类信息。
 图 9.4.2 描述了具有单个隐藏层的双向循环神经网络的架构。

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/birnn.svg" alt="双向循环神经网络架构" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.4.2 双向循环神经网络架构</p>
...
在 *小节《16.8 来自Transformers的双向编码器表示（BERT）.md》中*和 *小节《15.2 情感分析：使用循环神经网络.md》中*中，
...
请参阅 *小节《15.2 情感分析：使用循环神经网络.md》中*中的情感分类应用。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2774)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2773)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11835)。
