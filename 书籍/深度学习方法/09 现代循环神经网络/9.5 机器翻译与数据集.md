...
因此我们将其做为本章剩余部分和 *章节《10 注意力机制》中*的重点。
...
与 *小节《8.3 语言模型和数据集.md》中*中的字符级词元化不同，
在机器翻译中，我们更喜欢单词级词元化
（最先进的模型可能使用更高级的词元化技术）。
...
这个固定长度是由 *小节《8.3 语言模型和数据集.md》中*中的
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2777)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2776)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11836)。
