...
解决这一问题的最早方法之一是长短期存储器（long short-term memory，LSTM）
 。
它有许多与门控循环单元（ *小节《9.1 门控循环单元（GRU）.md》中*）一样的属性。
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/lstm-0.svg" alt="长短期记忆模型中的输入门、遗忘门和输出门" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.2.1 长短期记忆模型中的输入门、遗忘门和输出门</p>
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/lstm-1.svg" alt="长短期记忆模型中的候选记忆元" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.2.2 长短期记忆模型中的候选记忆元</p>
...
这样我们就得到了计算记忆元的流程图，如 图 9.2.3 。

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/lstm-2.svg" alt="在长短期记忆网络模型中计算记忆元" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.2.3 在长短期记忆网络模型中计算记忆元</p>
### 隐状态
...
而对于输出门接近$0$，我们只保留记忆元内的所有信息，而不需要更新隐状态。
 ...
 图 9.2.4 提供了数据流的图形化演示。

<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/lstm-3.svg" alt="在长短期记忆模型中计算隐状态" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 9.2.4 在长短期记忆模型中计算隐状态</p>

现在，我们从零开始实现长短期记忆网络。
与 *小节《8.5 rnn-scratch.md》中*中的实验相同，
我们首先加载时光机器数据集。
...
让我们通过实例化 *小节《8.5 rnn-scratch.md》中*中
引入的`RNNModelScratch`类来训练一个长短期记忆网络，
就如我们在 *小节《9.1 门控循环单元（GRU）.md》中*中所做的一样。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2766)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/2768)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11833)。