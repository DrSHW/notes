...
正如我们在 *小节《11.3 梯度下降》中学习率部分*中所看到的，选择“恰到好处”的学习率$\eta$是很棘手的。
...
毕竟，$f$的最小值满足$\nabla f = 0$。
遵循 *小节《2.4 微积分.md》中*中的微积分规则，
通过取$\boldsymbol{\epsilon}$对 公式 11.3.8 的导数，
再忽略不重要的高阶项，我们便得到
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/3834)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/3836)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/3835)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11848)。