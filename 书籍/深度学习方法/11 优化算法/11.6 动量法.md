...
在 *小节《11.4 随机梯度下降.md》中*一节中，我们详述了如何执行随机梯度下降，即在只有嘈杂的梯度可用的情况下执行优化时会发生什么。
...
回想我们在 *小节《11.3 梯度下降.md》中*中使用了$f(\mathbf{x}) = x_1^2 + 2 x_2^2$，即中度扭曲的椭球目标。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4327)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4328)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4329)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11851)。