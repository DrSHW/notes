 ...
 *小节《11.7 AdaGrad算法.md》中*中的关键问题之一，是学习率按预定时间表$\mathcal{O}(t^{-\frac{1}{2}})$显著降低。
...
回想在 *小节《11.7 AdaGrad算法.md》中*一节中，当我们使用学习率为0.4的Adagrad算法时，变量在算法的后期阶段移动非常缓慢，因为学习率衰减太快。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4321)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4322)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4323)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11853)。