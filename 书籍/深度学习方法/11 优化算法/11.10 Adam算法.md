...
* 在 *小节《11.4 随机梯度下降.md》中*中，我们学习了：随机梯度下降在解决优化问题时比梯度下降更有效。
* 在 *小节《11.5 小批量随机梯度下降.md》中*中，我们学习了：在一个小批量中使用更大的观测值集，可以通过向量化提供额外效率。这是高效的多机、多GPU和整体并行处理的关键。
* 在 *小节《11.6 动量法.md》中*中我们添加了一种机制，用于汇总过去梯度的历史以加速收敛。
* 在 *小节《11.7 AdaGrad算法.md》中*中，我们通过对每个坐标缩放来实现高效计算的预处理器。
* 在 *小节《11.8 RMSProp算法.md》中*中，我们通过学习率的调整来分离每个坐标的缩放。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4330)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4331)。

关于`tensorflow`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/4332)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11855)。
