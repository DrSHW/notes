...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/multi-head-attention.svg" alt="多头注意力：多个头连结然后线性变换" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 10.5.1 多头注意力：多个头连结然后线性变换</p>
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5757)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5758)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11843)。