 ...
 *小节《10.2 注意力汇聚：Nadaraya-Watson核回归.md》中*使用了高斯核来对查询和键之间的关系建模。
 公式 10.2.6 中的
...
<img src="C:/Users/17100/Desktop/知识库/深度学习方法/img/attention-output.svg" alt="计算注意力汇聚的输出为值的加权和" style="width:;display:block;margin-left:auto;margin-right:auto;background-color: white;">
<p style="text-align:center">图 10.3.1 计算注意力汇聚的输出为值的加权和</p>
...
例如，为了在 *小节《9.5 机器翻译与数据集.md》中*中高效处理小批量数据集，
某些文本序列被填充了没有意义的特殊词元。
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5751)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5752)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11841)。