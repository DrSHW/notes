...
$$
\mathbf{v}_w = \sum_{g\in\mathcal{G}_w} \mathbf{z}_g.\tag{16.6.1}
$$
...
关于`mxnet`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5747)。

关于`pytorch`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/5748)。

关于`paddle`的讨论，请参见[Disscussions](https://discuss.d2l.ai/t/11818)。
